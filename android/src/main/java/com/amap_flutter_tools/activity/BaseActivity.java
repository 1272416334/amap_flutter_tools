...
public class BaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener, ParallelRoadListener {
    ...
    static final List<NaviLatLng> sList = new ArrayList<NaviLatLng>();
    static final List<NaviLatLng> eList = new ArrayList<NaviLatLng>();
...
//        eList.add(mEndLatlng);
    ...
    static public void setLatLng(Map<String, Object> params) {
        final List<?> from = (List<?>) params.get("fromLatLng");
        final List<?> to = (List<?>) params.get("toLatLng");

        NaviLatLng mStartLatlng = new NaviLatLng(toFloat(from.get(0)),toFloat(from.get(1)));

        NaviLatLng mEndLatlng = new NaviLatLng(toFloat(to.get(0)), toFloat(to.get(1)));
